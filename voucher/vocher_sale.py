...
class VoucherInvoiceSale(VoucherBase):
    ...
    def __init__(self, company_name, object_name, begin_y, begin_m, begin_d, end_y, end_m, end_d):
        ...
        self.output_dir = os.path.join(self.output_dir, self.company_name, "销项发票凭证")
    ...
    def sum_price(self):
        ...
        self.model.write_cell(7, 6, self.sum_price_of_object)
    ...
    def tax(self):
        ...
        self.model.write_cell(8, 6, self.tax_of_object)
        return self.sum_price
    ...
    def object_loan(self):
        ...
        self.model.write_cell(6, 7, self.sum_price_of_object+self.tax_of_object)
